...
1. [Chap 7 explains many of the _**WHYS**_ behind why we are doing what we are doing](https://ledatascifi.github.io/ledatascifi-2023/content/05/03_ML.html) and introduces the new vocabulary you'll need to learn
1. [Chap 8 gives concrete code and pseudo code so you can get to work](https://ledatascifi.github.io/ledatascifi-2023/content/05/04a_SKLearn.html)
